 ...
 * methods of it in StylePropertyMapReadOnly, but in these tests, it won't
 * exist so we need to mock just the parts we need.
 */
...
describe("class StylePropertyMapReadOnly", () => {
  ...
  const styleMap = StylePropertyMapReadOnly._createInternal(
