...
| [StylePropertyMap.get()](https://developer.mozilla.org/en-US/docs/Web/API/StylePropertyMapReadOnly/get)                  | ✅ Yes       | Inherited from StylePropertyMapReadOnly                             |
| [StylePropertyMap.getAll()](https://developer.mozilla.org/en-US/docs/Web/API/StylePropertyMapReadOnly/getAll)            | ❌ No        | Inherited from StylePropertyMapReadOnly                             |
| [StylePropertyMap.has()](https://developer.mozilla.org/en-US/docs/Web/API/StylePropertyMapReadOnly/has)                  | ✅ Yes       | Inherited from StylePropertyMapReadOnly                             |
| [StylePropertyMap.keys()](https://developer.mozilla.org/en-US/docs/Web/API/StylePropertyMapReadOnly/keys)                | ✅ Yes       | Inherited from StylePropertyMapReadOnly                             |
| [StylePropertyMap.values()](https://developer.mozilla.org/en-US/docs/Web/API/StylePropertyMapReadOnly/values)            | ✅ Yes       | Inherited from StylePropertyMapReadOnly                             |
| **CSSStyleValue**                                                                                                        |              |                                                                     |
